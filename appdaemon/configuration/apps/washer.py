...
THRESHOLDS_TYPES = (
    CONF_RUNNING_THRESHOLD, CONF_DRYING_THRESHOLD, CONF_CLEAN_THRESHOLD
)
...
class NotifyWhenWasherDone(AppBase):
    ...
    APP_SCHEMA = APP_SCHEMA.extend({
        CONF_PROPERTIES: vol.Schema({
            vol.Required(vol.In(THRESHOLDS_TYPES)): int,
        }, extra=vol.ALLOW_EXTRA),
    ...
    def configure(self) -> None:
        ...
        self.listen_event(self.cancel_on_push_notification,
    ...
    def cancel_on_push_notification(self, event_name: str,
